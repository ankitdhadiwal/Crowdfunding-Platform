...
const Navbar = () => {
    ...
    return (
        <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
            <div className='lg:flex-1 flex flex-row max-w-[458px] py-2 pr-2 pl-2 h-[52px] bg-[#1c1c24] rounded-[100px]'>
                        ...
                        {navlinks.map((link) => (
                            ...
                            >
                                <img 
                                  src={link.imgUrl}
                                  alt={link.name}
                                  className={`w-[24px]h-[24px] object-contain ${isActive === link.name ? 'grayscale-0' : 
                                  'grayscale'}`}
                                />
                                <p className={`ml-[20px] font-epilogue font-semibold text-[14px] ${isActive === link.name
